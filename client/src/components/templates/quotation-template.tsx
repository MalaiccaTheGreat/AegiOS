    ...
    return (
      <div ref={ref} className="bg-white p-8 max-w-4xl mx-auto print:p-0 print:shadow-none">
        ...
        <div className="flex justify-between mb-8">
          ...
          <div className="text-right">
            <p><strong>No.</strong> {quotation.quotationNumber}</p>
            <p><strong>Date:</strong> {new Date(quotation.createdAt).toLocaleDateString('en-GB')}</p>
          </div>
        </div>
        ...
        <div className="text-right mb-12">
          <div className="inline-block">
            <div className="border-t-2 border-black pt-2">
              <p className="font-bold">TOTAL (K) {quotation.total.toLocaleString()}</p>
            </div>
          </div>
        </div>
